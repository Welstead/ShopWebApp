...
-Data validation on login also, using javascript/jquery

-Admin view for admin identity account

-CRUD operations for categories, category items and item content

-Users to Category page for admin user to assign registered users to categories in the database